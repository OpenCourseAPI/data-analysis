...
class Config:
    data_root = '../LiveMyPortalData/data/'
    interval_time = 60
    full_reset = True
...
class Settings:
    ...
    def __init__(self, term_codes, start_sha = None, end_sha = None, snapshot_sha = None, term_colors = [Colors.CBEIGE2, Colors.CYELLOW2]):
...
Summer2020 = Settings(
    ...
    # The following SHA has lots of courses deleted
